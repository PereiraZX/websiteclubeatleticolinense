...
<head>
    ...
    <title>Clube Atlético Linense | Adminstrador</title>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="assets/images/CAL_logo_p.png" type="image/x-icon">
</head>

<body>
    <navbar class="navbar-side">
        <div class="container">
            ...
            <a href="" class="nav-item">
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person-workspace"
                        viewBox="0 0 16 16">
                        <path
            ...
            <a href="" class="nav-item">
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person-lines-fill"
                        viewBox="0 0 16 16">
                        <path
    ...
    <header class="header">
        <div class="container">
            <div class="content">
                <img src="./assets/images/CAL_logo_p.png" alt="Clube Atlético Linense" class="logo">
                <div>
                    <h2>Clube Atletico Linense</h2>
                    <span id="sessao">Home</span>
                </div>
            </div>
            <div class="assets">
                <button id="button-dark-mode">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-moon" viewBox="0 0 16 16" id="icon-dark-mode">
                        <path
                            d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278zM4.858 1.311A7.269 7.269 0 0 0 1.025 7.71c0 4.02 3.279 7.276 7.319 7.276a7.316 7.316 0 0 0 5.205-2.162c-.337.042-.68.063-1.029.063-4.61 0-8.343-3.714-8.343-8.29 0-1.167.242-2.278.681-3.286z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16" id="icon-light-mode">
                ...
                <div class="user">
                    ...
                    <div class="dropdown-user">
                        <ul class="list">
                            <li class="list-item">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person-gear"
                                    viewBox="0 0 16 16">
                                    <path
    ...
    <footer class="footer">
        <div class="container">
            <p>Em desenvolvimento, com <strong><i class="fa fa-heart" aria-hidden="true"></i></strong> por<strong>
                    Heitor Felipe, João Guilherme & João Pedro</strong> </p>
        </div>
    </footer>
</body>
